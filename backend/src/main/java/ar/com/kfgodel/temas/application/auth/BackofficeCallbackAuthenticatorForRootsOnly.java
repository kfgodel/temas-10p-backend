 ...
 */
public class BackofficeCallbackAuthenticatorForRootsOnly extends BackofficeCallbackAuthenticator {

    public static BackofficeCallbackAuthenticator create(DependencyInjector appInjector) {
        BackofficeCallbackAuthenticator authenticator = new BackofficeCallbackAuthenticatorForRootsOnly();
